...
export const NetworkStatus: React.FC<NetworkStatusProps> = ({ 
  ...
  return (
    <div className="fixed top-4 left-4 bg-gray-800/90 backdrop-blur-sm rounded-lg p-3 border border-gray-700">
      <div className="flex items-center gap-3">
        ...
        {!isMaster && isConnected && (
          <div className="border-l border-gray-600 pl-3">
            <span className="text-xs text-gray-400">Display Client</span>
          </div>
        )}
      </div>
